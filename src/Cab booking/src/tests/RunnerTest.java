...
public class RunnerTest {
    ...
    public void setUp() {
        ...
        cabsController = new CabsController(cabsManager);
    ...
    public void testCabBookingFlow() {
        ...
        ridersController.bookCab(r1, 0.0, 0.0, 500.0, 500.0);
        ridersController.bookCab(r2, 0.0, 0.0, 500.0, 500.0);

        System.out.println("\n### Printing current trips for r1 and r2");
        System.out.println(ridersController.fetchHistory(r1).toString());
        System.out.println(ridersController.fetchHistory(r2).toString());
        ...
        assertThrows(NoCabAvailableException.class, () -> {
            ridersController.bookCab(r3, 0.0, 0.0, 500.0, 500.0);
        });

        ridersController.bookCab(r4, 48.0, 48.0, 500.0, 500.0);
        System.out.println("\n### Printing current trips for r1, r2 and r4");
        System.out.println(ridersController.fetchHistory(r1).toString());
        System.out.println(ridersController.fetchHistory(r2).toString());
        System.out.println(ridersController.fetchHistory(r4).toString());

        assertThrows(RiderNotFoundException.class, () -> {
            ridersController.bookCab("abcd", 0.0, 0.0, 500.0, 500.0);
        });
